...
struct hdr {
  ...
  uint64_t rings_off,planes_off,page_off,mask_off,send_off,base_off,data_off,length;
  _Atomic uint64_t client,bridge_pid,sent,recvd,bad;
