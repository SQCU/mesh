...
| 19 measured run (bounded to one-shot instances, no transport reuse needed) | K | hardware; pinned mesh `d61e503` (ABI 47) + engine `aad2874` on both nodes; evidence `metal-microbench/output_data/mesh_e3/` |
