...
b "DAEMONS"; for spec in io.mesh.caffeinate:resident io.mesh.beacon:resident io.mesh.keeper:periodic io.mesh.fabric:oneshot io.mesh.router:resident io.mesh.rdma-init:oneshot; do
  L=${spec%%:*}; kind=${spec##*:}
