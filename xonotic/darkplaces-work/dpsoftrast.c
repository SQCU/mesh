...
static void DPSOFTRAST_PixelShader_LightSource(DPSOFTRAST_State_Thread *thread, const DPSOFTRAST_State_Triangle * RESTRICT triangle, const DPSOFTRAST_State_Span * RESTRICT span)
{
	...
	unsigned char buffer_FragColorbgra8[DPSOFTRAST_DRAW_MAXSPANLENGTH*4];
	int x, startx = span->startx, endx = span->endx;
	float Color_Ambient[4], Color_Diffuse[4], Color_Specular[4],                    Color_Pants[4], Color_Shirt[4], LightColor[4];
	...
	DPSOFTRAST_Draw_Span_Begin(thread, triangle, span, buffer_z);
	memset(buffer_FragColorbgra8 + startx*4, 0, (endx-startx)*4);
	DPSOFTRAST_Draw_Span_Texture2DVaryingBGRA8(thread, triangle, span, buffer_texture_colorbgra8, GL20TU_COLOR, DPSOFTRAST_ARRAY_TEXCOORD0, buffer_z);
	if (thread->shader_permutation & SHADERPERMUTATION_COLORMAPPING)
	{
		DPSOFTRAST_Draw_Span_Texture2DVaryingBGRA8(thread, triangle, span, buffer_texture_pantsbgra8, GL20TU_PANTS, DPSOFTRAST_ARRAY_TEXCOORD0, buffer_z);
...
static void DPSOFTRAST_PixelShader_Refraction(DPSOFTRAST_State_Thread *thread, const DPSOFTRAST_State_Triangle * RESTRICT triangle, const DPSOFTRAST_State_Span * RESTRICT span)
{
	...
	for (x = startx;x < endx;x++)
	{
		...
		iw = 1.0f / (ModelViewProjectionPositiondata[3] + ModelViewProjectionPositionslope[3]*x);

		SafeScreenTexCoord[0] = (ModelViewProjectionPositiondata[0] + ModelViewProjectionPositionslope[0]*x) * iw * ScreenScaleRefractReflect[0] + ScreenCenterRefractReflect[0];
		SafeScreenTexCoord[1] = (ModelViewProjectionPositiondata[1] + ModelViewProjectionPositionslope[1]*x) * iw * ScreenScaleRefractReflect[1] + ScreenCenterRefractReflect[1];
...
static void DPSOFTRAST_PixelShader_Water(DPSOFTRAST_State_Thread *thread, const DPSOFTRAST_State_Triangle * RESTRICT triangle, const DPSOFTRAST_State_Span * RESTRICT span)
{
	...
	for (x = startx;x < endx;x++)
	{
		...
		SafeScreenTexCoord[0] = (ModelViewProjectionPositiondata[0] + ModelViewProjectionPositionslope[0]*x) * iw * ScreenScaleRefractReflect[0] + ScreenCenterRefractReflect[0];
		SafeScreenTexCoord[1] = (ModelViewProjectionPositiondata[1] + ModelViewProjectionPositionslope[1]*x) * iw * ScreenScaleRefractReflect[1] + ScreenCenterRefractReflect[1];
		SafeScreenTexCoord[2] = (ModelViewProjectionPositiondata[0] + ModelViewProjectionPositionslope[0]*x) * iw * ScreenScaleRefractReflect[2] + ScreenCenterRefractReflect[2];
		SafeScreenTexCoord[3] = (ModelViewProjectionPositiondata[1] + ModelViewProjectionPositionslope[1]*x) * iw * ScreenScaleRefractReflect[3] + ScreenCenterRefractReflect[3];
		...
		v[0] = (EyeVectordata[0] + EyeVectorslope[0] * x);
		v[1] = (EyeVectordata[1] + EyeVectorslope[1] * x);
		v[2] = (EyeVectordata[2] + EyeVectorslope[2] * x);
		DPSOFTRAST_Vector3Normalize(v);
		Fresnel = 1.0f - v[2];
...
#define GENATTRIBS(attrib0, attrib1, attrib2) \
		...
		for (; y < bandy;)
		{
			...
			if (numpoints == 4)
			{
				...
				{
				default:
				case 0xFFFF:          y = endy; continue;
				case 0xFFF0:          edge0p = 3;edge0n = 0;edge1p = 1;edge1n = 0;break;
				case 0xFF0F:          edge0p = 0;edge0n = 1;edge1p = 2;edge1n = 1;break;
				case 0xFF00:          edge0p = 3;edge0n = 0;edge1p = 2;edge1n = 1;break;
				case 0xF0FF:          edge0p = 1;edge0n = 2;edge1p = 3;edge1n = 2;break;
				case 0xF0F0:          edge0p = 1;edge0n = 2;edge1p = 3;edge1n = 2;break;
				case 0xF00F:          edge0p = 0;edge0n = 1;edge1p = 3;edge1n = 2;break;
				case 0xF000:          edge0p = 3;edge0n = 0;edge1p = 3;edge1n = 2;break;
				case 0x0FFF:          edge0p = 2;edge0n = 3;edge1p = 0;edge1n = 3;break;
				case 0x0FF0:          edge0p = 2;edge0n = 3;edge1p = 1;edge1n = 0;break;
				case 0x0F0F:          edge0p = 2;edge0n = 3;edge1p = 2;edge1n = 1;break;
				case 0x0F00:          edge0p = 2;edge0n = 3;edge1p = 2;edge1n = 1;break;
				case 0x00FF:          edge0p = 1;edge0n = 2;edge1p = 0;edge1n = 3;break;
				case 0x00F0:          edge0p = 1;edge0n = 2;edge1p = 1;edge1n = 0;break;
				case 0x000F:          edge0p = 0;edge0n = 1;edge1p = 0;edge1n = 3;break;
				case 0x0000:          y++; continue;
				}
			}
			else
			{
				...
				default:
				case 0xFFFF:         y = endy; continue;
				case 0xFFF0:         edge0p = 2;edge0n = 0;edge1p = 1;edge1n = 0;break;
				case 0xFF0F:         edge0p = 0;edge0n = 1;edge1p = 2;edge1n = 1;break;
				case 0xFF00:         edge0p = 2;edge0n = 0;edge1p = 2;edge1n = 1;break;
				case 0x00FF:         edge0p = 1;edge0n = 2;edge1p = 0;edge1n = 2;break;
				case 0x00F0:         edge0p = 1;edge0n = 2;edge1p = 1;edge1n = 0;break;
				case 0x000F:         edge0p = 0;edge0n = 1;edge1p = 0;edge1n = 2;break;
				case 0x0000:         y++; continue;
				}
			}
