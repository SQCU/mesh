...
"\n",
"#ifdef USEFXAA\n",
"	dp_FragColor = fxaa(dp_FragColor, 8.0, TexCoord1, Texture_First, PixelSize);\n",
"#endif\n",
"\n",
...
"#endif\n",
"out float3 VectorS : TEXCOORD5,\n",
"out float3 VectorT : TEXCOORD6,\n",
"out float4 VectorR : TEXCOORD7\n",
")\n",
"{\n",
...
"float3 VectorS : TEXCOORD5,\n",
"float3 VectorT : TEXCOORD6,\n",
"float4 VectorR : TEXCOORD7,\n",
"uniform sampler Texture_Normal : register(s0),\n",
"#ifdef USEALPHAKILL\n",
...
"uniform float2 ScreenToDepth : register(c33),\n",
...
"out float3 VectorS : TEXCOORD5,\n",
"out float3 VectorT : TEXCOORD6,\n",
"out float3 VectorR : TEXCOORD7,\n",
"#endif\n",
"#ifdef USESHADOWMAPORTHO\n",
"out float3 ShadowMapTC : TEXCOORD3,\n",
"#endif\n",
"out float4 gl_Position : POSITION\n",
")\n",
"{\n",
...
"float3 VectorS : TEXCOORD5,\n",
"float3 VectorT : TEXCOORD6,\n",
"float3 VectorR : TEXCOORD7,\n",
"#endif\n",
"#ifdef USESHADOWMAPORTHO\n",
"float3 ShadowMapTC : TEXCOORD3,\n",
"#endif\n",
"\n",
"uniform sampler Texture_Normal : register(s0),\n",
"uniform sampler Texture_Color : register(s1),\n",
