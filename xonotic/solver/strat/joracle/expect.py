...
FIELDS = [
    ...
    ("assignments",       "per-player assignment rows",  "strat_responder assignments",     "behavior: request + applied target + stock goal + contact"),
    ...
    ("model.score",       "action logits",               "strategy() composer",      "INTERNALS: the sampled distribution"),
    ...
    ("model.appetite",    "appetite (IR @ keys)",        "strategy() composer",      "INTERNALS: pre-DPP per-instrument affinity"),
